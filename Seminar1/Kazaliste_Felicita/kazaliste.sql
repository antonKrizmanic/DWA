...
(12,17,2,'L\'esercito','Quando gli nemici non esistono – gli si devono inventare. Questo è il pensiero di base del dramma creato da un drammaturgo pollaco nel 1958.\r\nQuesto dramma breve e comico si svolge in due atti con cinque personaggi. Inoltre, è orientato contro il regima totalitario, specialmente quello comunista. Molti letterari si sono ispirati a molti funzionari di partito, agli aparati statali ed a ogni sorte di idolatria, così come ha fatto anche Mrožek.\r\nIl motivo dell\'assurdo nell\' „Esercito“ è intrecciato nella visione di una futura immagine dell\'umanità molto oscura, però forse anche reale: chi attacherà l\'esercito se tutti sono uniti? Perchè, l\'esercito deve pure esistere. L\'esercito costituito dai generali, dai comandanti e dai militari sicuramente vive e sopravvive. Però, se la guerra non esiste, si perde lo scopo dell\'esercito. Infine, la farsa finisce in modo che tutti si dichiarano la guerra, follemente, a causa della sciochezza, ma sopratutto a causa della loro debolezza  interna.\r\n');
